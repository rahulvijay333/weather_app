...
import 'package:weather_app/model/forcast/forcasted_weather_model/forecastday.dart';

class Forcast3DayWidget extends StatelessWidget {
  const Forcast3DayWidget({
    super.key,
    required this.size,
